...
mixin _$DateRange {
  /// start
  @JsonKey(name: DateRange.startKey_)
  DateTime get start;

  /// end
  @JsonKey(name: DateRange.endKey_)
  DateTime get end;
...
abstract mixin class $DateRangeCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {@JsonKey(name: DateRange.startKey_) DateTime start,
      @JsonKey(name: DateRange.endKey_) DateTime end});
}
...
extension DateRangePatterns on DateRange {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(@JsonKey(name: DateRange.startKey_) DateTime start,
            @JsonKey(name: DateRange.endKey_) DateTime end)?
        $default, {
    required TResult orElse(),
  }) {
...
class _DateRange extends DateRange {
  const _DateRange(
      {@JsonKey(name: DateRange.startKey_) required this.start,
      @JsonKey(name: DateRange.endKey_) required this.end})
      : super._();
